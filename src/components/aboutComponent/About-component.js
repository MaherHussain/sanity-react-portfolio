            ...
            <div className="col-lg-6 col-md-12 pl-0 pr-0">
              <div className="about-text ">
                <p className="animate__animated animate__backInRight">
                  ...
                  imaginative web developer who is able to work independently as
                  well as alongside other developers in creating websites of the
                  very highest standards. I can and like building websites using
